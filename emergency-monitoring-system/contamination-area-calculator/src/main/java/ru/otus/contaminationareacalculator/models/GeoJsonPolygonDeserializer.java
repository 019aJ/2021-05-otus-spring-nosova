...
public class GeoJsonPolygonDeserializer extends JsonDeserializer<TransformResult> {
    @Override
    public TransformResult deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        return new TransformResult(polygons);
    }
}